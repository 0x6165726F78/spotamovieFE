...
I18n.translations = {
  ...
  en: {
    ...
    welcome: "Welcome",
    reco: 'RECOMMENDATION',
    recommendations: 'Get movie recommendations based on your music preferences',
    ...
    appYoung: "This app is young, so we need to create a base of movie preferences to detect connections with your music taste.",
    skipIt: "SKIP IT",
  ...
  fr: {
    welcome: "Bienvenue",
    reco: 'RECOMMANDATION',
    recommendations: 'Obtenez des recommandations de films en fonction de vos préférences musicales',
    signIn: "Connectez-vous avec Spotify afin que nous puissions traiter vos playlists",
    ...
    appYoung: "Cette application est jeune, donc nous devons créer une base de préférences de films pour détecter les connexions avec votre goût musical.",
    skipIt: "SAUTER",
  ...
  ar: {
    welcome: "أهلا بك",
    reco: 'توصية',
    recommendations: "الحصول على توصيات الفيلم استنادا إلى التفضيلات الموسيقية الخاصة بك",
    signIn: "سجل الدخول باستخدام سبوتيفي حتى نتمكن من معالجة قوائم التشغيل التابعة لك",
    ...
    appYoung: "هذا التطبيق هو الشباب، لذلك نحن بحاجة إلى إنشاء قاعدة من تفضيلات الفيلم للكشف عن اتصالات مع طعم الموسيقى الخاصة بك.",
    skipIt: "تخطاها",
  ...
  es: {
    welcome: "Bienvenido",
    reco: 'RECOMENDACIÓN',
    recommendations: "Obtenga recomendaciones de películas basadas en sus preferencias de música",
    signIn: "Inicia sesión con Spotify para poder procesar tus listas de reproducción",
    ...
    appYoung: "Esta aplicación es joven, por lo que necesitamos crear una base de preferencias de películas para detectar conexiones con tu gusto musical.",
    skipIt: "SALTARLO",
  ...
  ru: {
    ...
    reco: 'РЕКОМЕНДАЦИЯ',
    recommendations: "Получите рекомендации по фильмам на основе ваших музыкальных предпочтений",
    signIn: "Войдите в систему с помощью Spotify, чтобы мы могли обрабатывать ваши плейлисты",
    ...
    appYoung: "Это приложение молодое, поэтому нам нужно создать основу предпочтений фильма, чтобы обнаружить связи с вашим музыкальным вкусом.",
    skipIt: "ПРОПУСТИ ЭТО",
